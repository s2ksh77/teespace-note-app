...
var EditorStore = mobx.observable((_observable = {
  ...
  this.isFile = flag;
}), _defineProperty(_observable, "removeFileList", function removeFileList(fileId) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return EditorStore.getDuflicateFile(item.model.storageFileInfo.file_name, item.model.storageFileInfo.file_extension);

        case 4:
          duplicateName = _context.sent;
          _context.next = 7;
          return EditorStore.uploadFileGW(item.file, duplicateName, item.model.storageFileInfo.file_extension, handleUploadProgress, item.cancelSource).catch(function (e) {
            if (e !== 'Network Error') {
        ...
        return regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
                _context23.next = 2;
                return teespaceCore.API.post("/gateway-api/upload?channel=" + this.chId + '&name=' + fixedEncodeURIComponent(fileName) + '&ext=' + fileExtension + '&location=' + fixedEncodeURIComponent(fileName + '.' + fileExtension) + '&dir=' + "".concat(PageStore.pageInfo.id), file, {
                  headers: {
          ...
          while (1) {
            switch (_context30.prev = _context30.next) {
              case 0:
                _context30.prev = 0;
                _context30.next = 3;
                return teespaceCore.API.get("/drive-api/files/".concat(PageStore.pageInfo.id, "?type=0&name=").concat(fixedEncodeURIComponent(fileName), "&ext=").concat(fileExt));
