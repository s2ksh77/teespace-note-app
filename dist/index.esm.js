import { observable, toJS, flow } from 'mobx';
...
var handleUpload = flow( /*#__PURE__*/regeneratorRuntime.mark(function handleUpload(item) {
        ...
        return regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
                _context23.next = 2;
                return API.post("/gateway-api/upload?channel=" + this.chId + '&name=' + fixedEncodeURIComponent(fileName) + '&ext=' + fileExtension + '&location=' + fixedEncodeURIComponent(fileName + '.' + fileExtension) + '&dir=' + "".concat(PageStore.pageInfo.id), file, {
                  headers: {
