...
}), _defineProperty(_observable, "deleteAllFile", function deleteAllFile(fileList) {
  var _this2 = this;
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return NoteRepository$1.deleteAllFile(fileList ? fileList : _this2.fileList).then(function (response) {
        ...
        return regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
                _context23.next = 2;
                return API.post("/gateway-api/upload?channel=" + this.chId + '&name=' + fixedEncodeURIComponent(fileName) + '&ext=' + fileExtension + '&location=' + location + '&dir=' + "".concat(PageStore.pageInfo.id), file, {
                  headers: {
