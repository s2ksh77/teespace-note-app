...
var PageStore = observable((_observable$1 = {
  ...
  noteNoneEdit: function noteNoneEdit(noteId) {
    ...
    this.noneEdit(noteId, this.currentPageData.parent_notebook, this.prevModifiedUserName).then(function (dto) {
      ...
      (_EditorStore$tinymce3 = EditorStore.tinymce) === null || _EditorStore$tinymce3 === void 0 ? void 0 : _EditorStore$tinymce3.setContent(_this10.currentPageData.note_content);
      NoteStore$1.setShowModal(false);
    });
  },
  ...
  handleSave: function handleSave() {
    ...
    (_EditorStore$tinymce5 = EditorStore.tinymce) === null || _EditorStore$tinymce5 === void 0 ? void 0 : _EditorStore$tinymce5.undoManager.clear();
    ...
    return regeneratorRuntime.wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 5:
            _this16.setFirstMoveInfoList(targetChapter);
