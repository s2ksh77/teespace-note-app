          ...
          switch (_context16.prev = _context16.next) {
            ...
            case 11:
              ...
              return _context16.abrupt("return", {
                chapterId: _this11.currentChapterId,
          ...
          while (1) {
            switch (_context32.prev = _context32.next) {
              case 0:
                _context32.prev = 0;
                _context32.next = 3;
                return API.post("note-api/bookmark", {
                  dto: {
                    note_id: pageId
                  }
                });
          ...
          while (1) {
            switch (_context33.prev = _context33.next) {
              case 0:
                _context33.prev = 0;
                _context33.next = 3;
                return API.post("note-api/bookmark?action=Delete", {
                  dto: {
                    note_id: pageId
                  }
                });
          ...
          while (1) {
            switch (_context34.prev = _context34.next) {
              case 0:
                ...
                _context34.prev = 1;
                _context34.next = 4;
                return API.get("note-api/bookmark?action=List".concat(query));
          ...
          while (1) {
            switch (_context35.prev = _context35.next) {
              case 0:
                ...
                _context35.prev = 1;
                _context35.next = 4;
                return API.get("note-api/noteRecent?action=List&note_channel_id=".concat(this.chId).concat(query));
