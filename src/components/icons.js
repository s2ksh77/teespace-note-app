...
export const TrashIcon = React.memo(({ width = 1, height = 1, color = '#666' }) => {
  const defaultWidth = 24;
  const defaultHeight = 24;
...
export const ShareIcon = React.memo(({ width = 1, height = 1, color = '#666' }) => {
  const defaultWidth = 24;
  const defaultHeight = 24;
...
export const SharedPageIcon = React.memo(({ width = 1, height = 1, color = '#666' }) => {
  const defaultWidth = 24;
  const defaultHeight = 24;
