...
export const NewAddIcon = React.memo(
  ({ width = 1.75, height = 1.75, color = '#FFFFFF', onClick, display = 'flex' }) => {
...
export const EditIcon = React.memo(
  ({ width = 1, height = 1, color = '#FFFFFF', onClick, disabled }) => {
    const defaultWidth = 24;
    const defaultHeight = 24;
    return (
      <svg
      ...
      >
        ...
        >
          <path
            d="M20.2102813,3.79282884 C20.7143643,4.29783592 20.9915095,4.96983739 20.9915095,5.68409044 C20.9915095,6.23537308 20.8228124,6.75848799 20.5155427,7.20212967 L16.8102317,3.49002578 C17.8384806,2.79991649 19.3175926,2.89850353 20.2102813,3.79282884 L20.2102813,3.79282884 Z M15.3542151,4.8762803 L17.0431943,6.56835584 L14.7848625,8.83183382 C14.3932442,9.22417 14.3932442,9.86096181 14.7848625,10.254304 C14.9806716,10.4504721 15.2377338,10.5490591 15.4947961,10.5490591 C15.7518583,10.5490591 16.0089205,10.4504721 16.2047296,10.254304 L18.4630615,7.990826 L19.1288125,8.65779751 L11.3818004,16.419012 C11.1337755,15.5800162 10.6477672,14.7540982 9.95791661,14.0639889 C9.26404942,13.3688497 8.44165112,12.8849684 7.60619887,12.6374948 L15.3542151,4.8762803 Z M5.47639812,19.6331508 L4.45316995,18.6090527 C4.42907037,18.583903 4.39593344,18.574849 4.3708297,18.5527173 L5.88006616,14.5347923 C6.52673833,14.3164925 7.61925281,14.566984 8.53804945,15.4864591 C9.48998302,16.4401378 9.69683779,17.5205713 9.49199132,18.1442852 L5.47639812,19.6331508 Z M10.6748792,19.8474267 C10.7341241,19.8252949 10.7843315,19.7810313 10.8395597,19.7458217 C10.8988045,19.7086 10.9630701,19.6794263 11.0112693,19.6321448 C11.0152859,19.6281208 11.0203066,19.6271148 11.0233191,19.6230909 L21.6301485,8.9978222 C22.5137999,8.11255082 22.9998082,6.93554227 22.9998082,5.68409044 C22.9998082,4.43263861 22.5137999,3.25563006 21.6301485,2.37035867 C19.8066133,0.543480443 16.839352,0.543480443 15.0148127,2.37035867 L4.40798323,12.9956273 C4.40497078,12.9986453 4.40497078,13.0026692 4.40195833,13.0056872 C4.35275502,13.0559867 4.32263054,13.1213761 4.28547701,13.1817355 C4.25133593,13.236059 4.20715336,13.2843465 4.18506208,13.341688 C4.18405793,13.3467179 4.18004133,13.3487299 4.17803303,13.3527538 L1.06416594,21.6390952 C0.92559333,22.0072877 1.01496262,22.4237676 1.29210784,22.7034329 C1.48390036,22.896583 1.74196674,23.0002 2.00404972,23.0002 L14.6493023,23.0002 C15.1483645,23.0002 15.5530367,22.59378 15.5530367,22.0938028 C15.5530367,21.5938257 15.1483645,21.1894176 14.6493023,21.1894176 L7.06697067,21.1894176 L10.6618253,19.8564806 C10.666846,19.8544686 10.6708626,19.8494386 10.6748792,19.8474267 L10.6748792,19.8474267 Z"
            id="Fill-1"
  ...
  ({ width = 1, height = 1, color = '#FFFFFF', onClick, disabled }) => {
    ...
    return (
      ...
      >
        ...
        >
          <path
            d="M17.566,1.0003 C20.562,1.0003 23,3.4423 23,6.4433 L23,6.4433 L23,17.5513 C23,20.5533 20.562,22.9953 17.566,22.9953 L17.566,22.9953 L6.483,22.9953 C3.487,22.9953 1.05,20.5533 1.05,17.5513 C1.05,16.9993 1.497,16.5513 2.05,16.5513 C2.603,16.5513 3.05,16.9993 3.05,17.5513 C3.05,19.4503 4.59,20.9953 6.483,20.9953 L6.483,20.9953 L17.566,20.9953 C19.46,20.9953 21,19.4503 21,17.5513 L21,17.5513 L21,6.4433 C21,4.5453 19.46,3.0003 17.566,3.0003 L17.566,3.0003 L6.483,3.0003 C4.59,3.0003 3.05,4.5453 3.05,6.4433 C3.05,6.9953 2.603,7.4433 2.05,7.4433 C1.497,7.4433 1.05,6.9953 1.05,6.4433 C1.05,3.4423 3.487,1.0003 6.483,1.0003 L6.483,1.0003 Z M8.729,7.3564 C9.119,6.9664 9.754,6.9694 10.144,7.3614 L10.144,7.3614 L13.776,11.0214 C14.314,11.5684 14.312,12.4504 13.771,12.9894 L13.771,12.9894 L10.125,16.6364 C9.93,16.8314 9.674,16.9294 9.418,16.9294 C9.162,16.9294 8.906,16.8314 8.711,16.6364 C8.32,16.2454 8.32,15.6124 8.711,15.2224 L8.711,15.2224 L10.93,13.0034 L2,13.0034 C1.447,13.0034 1,12.5554 1,12.0034 C1,11.4514 1.447,11.0034 2,11.0034 L2,11.0034 L10.94,11.0034 L8.724,8.7704 C8.335,8.3784 8.337,7.7454 8.729,7.3564 Z"
            id="Combined-Shape"
            fill={color}
          />
        </g>
...
// SuperApp Icons
const SUPERAPP_REM_UNIT = 22;

export const MyNoteIcon = React.memo(({ width = 1, height = 1, color = '#191919' }) => {
  return (
    <svg
      width={`${width}rem`}
      height={`${width}rem`}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.5482 5.89046C14.3726 4.92877 12.6401 5.10212 11.6784 6.27764L6.5914 12.4957C6.06945 13.1337 5.86123 13.9722 6.02406 14.7803L6.24572 15.8802C6.4104 16.6974 7.12865 17.285 7.96227 17.2845L9.08434 17.2839C9.90864 17.2834 10.6892 16.9132 11.2112 16.2752L16.2982 10.0571C17.2599 8.88155 17.0865 7.149 15.911 6.18731L15.5482 5.89046ZM12.8394 7.22744C13.2765 6.69311 14.064 6.61432 14.5984 7.05145L14.9612 7.3483C15.4955 7.78543 15.5743 8.57295 15.1372 9.10728L10.0502 15.3254C9.81296 15.6154 9.45814 15.7837 9.08346 15.7839L7.96138 15.7845C7.84229 15.7846 7.73969 15.7007 7.71616 15.5839L7.4945 14.484C7.42049 14.1167 7.51513 13.7355 7.75238 13.4455L12.8394 7.22744Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.25 5C1.25 2.92893 2.92893 1.25 5 1.25H17C19.0711 1.25 20.75 2.92893 20.75 5V17C20.75 19.0711 19.0711 20.75 17 20.75H5C2.92893 20.75 1.25 19.0711 1.25 17V15.25H1C0.585786 15.25 0.25 14.9142 0.25 14.5C0.25 14.0858 0.585786 13.75 1 13.75H1.25V8.25H1C0.585786 8.25 0.25 7.91421 0.25 7.5C0.25 7.08579 0.585786 6.75 1 6.75H1.25V5ZM2.75 17V15.25H4C4.41421 15.25 4.75 14.9142 4.75 14.5C4.75 14.0858 4.41421 13.75 4 13.75H2.75V8.25H4C4.41421 8.25 4.75 7.91421 4.75 7.5C4.75 7.08579 4.41421 6.75 4 6.75H2.75V5C2.75 3.75736 3.75736 2.75 5 2.75H17C18.2426 2.75 19.25 3.75736 19.25 5V17C19.25 18.2426 18.2426 19.25 17 19.25H5C3.75736 19.25 2.75 18.2426 2.75 17Z"
        fill={color}
      />
    </svg>
  );
